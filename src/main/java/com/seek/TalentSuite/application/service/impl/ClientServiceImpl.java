...
import static com.seek.TalentSuite.application.constants.AppConstants.createApplicationException;
...
public class ClientServiceImpl implements ClientService {
    ...
    @Transactional(rollbackFor = ApplicationException.class, isolation = Isolation.SERIALIZABLE)
    @CacheEvict(value = "clients", allEntries = true)
    @Override
    ...
    public ClientsMetrics getMetrics() {
        log.info("Getting metrics from metrics service");
    ...
    public PageResponse<ClientDtoResponse> getClientsData(Pageable pageable) {
        log.info("Getting info of the clients");
        ...
        Page<ClientDtoResponse> finalPage = clients.map(this::calculateAgeToRetire);
    ...
    public void deleteClient(Long id) {
        clientRepository.getClientById(id).orElseThrow( createApplicationException("Client not found",String.format("The client with ID %s was not found",id),ErrorCode.ERROR_CLIENT_NOT_FOUND,HttpStatus.NOT_FOUND));
    ...
    public ClientDtoResponse calculateAgeToRetire(ClientDtoResponse clientDtoResponse){
